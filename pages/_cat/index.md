...
<div style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center;">
  ...
  <img src="{{ '/assets/images/jingjing7.jpg' | relative_url }}" alt="Jingjing 7" style="width: 22%; height: auto; border-radius: 6px;">
...
<div style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center;margin-top: 12px;">
  ...
  <img src="{{ '/assets/images/jingjing5.jpg' | relative_url }}" alt="Jingjing 5" style="width: 22%; height: auto; border-radius: 6px;">
  <img src="{{ '/assets/images/jingjing6.jpg' | relative_url }}" alt="Jingjing 6" style="width: 22%; height: auto; border-radius: 6px;">
  <img src="{{ '/assets/images/jingjing8.jpg' | relative_url }}" alt="Jingjing 8" style="width: 22%; height: auto; border-radius: 6px;">
</div>